...
function preload() {
  maceta = loadImage("img/maceta.jpg");
  centro = loadImage("img/centro.jpg");
  petalo = loadImage("img/petalo.jpg");
  tallo = loadImage("img/tallo.jpg");
  cuadro = loadImage("img/cuadro.jpg");
