...
<Language code="en">
This will be a brief description of the work (min 150 - max 200 words). The work creates dynamic figures in fluid movement, inspired by the work of Ben Laposky with his generative art. Rotations, sine and cosine are used to control the movement of the circles and lines. The interaction of lines and curves produces a captivating visual effect, fusing art and technology.

**Technical, aesthetic and conceptual development**

Technical, aesthetic and conceptual development (describe in a minimum of 200 and a maximum of 500 words the technical, aesthetic, conceptual characteristics, artistic references and bibliography used).
