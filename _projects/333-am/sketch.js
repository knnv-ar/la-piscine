...
function preload() {
  img1 = loadImage("testparallaxv4.png");

  videos.push(createVideo("computerballetanimations2.mp4"));
  videos.push(createVideo("publicidades.mp4"));
  videos.push(createVideo("lamascara.mp4"));
}
