...
function auraBrillante(){
  for(var y = 0; y <= height; y += 30){
    for (var x = 0; x <= height; x += 30) {
      ...
      bezier(aleatorio,aleatorioAncho,height/2,width/2,x,y,aleatorio,aleatorioAncho)
...
function auraExpansiva(){
  ...
  for(var y = 0; y <= 50; y += 10){
      for (var x = 0; x <= 50; x += 10) {
          bezier(random(agrandaMenos,agrandaMas),random(agrandaMenos,agrandaMas),height/2,width/2,height/2,width/2,random(agrandaMenos,agrandaMas),random(agrandaMenos,agrandaMas))
        aleatorio=random(0,height)
        aleatorioAncho=random(0,width)
      }
  }
