...
Regarding the range of grays that I used, I wanted to go for the classic soft and black to further highlight the geometric figures present in the work. I wanted the work to have a somewhat minimalist concept so that it would not look overloaded or that the viewer would get lost among so many things, since the idea was to highlight the ovals in motion.
