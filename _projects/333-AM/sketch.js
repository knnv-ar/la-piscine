...
function preload() {
  img1 = loadImage("imagenes/test_parallaxv4.png");

  videos.push(createVideo("videos/computer_ballet_animations_2.mp4"));
  videos.push(createVideo("videos/publicidades.mp4"));
  videos.push(createVideo("videos/la_mascara.mp4"));
}
