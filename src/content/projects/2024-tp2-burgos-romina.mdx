...
<Language code="en">
"Symphony of Colors" is an interactive work that takes you to a world full of magic and creativity. With bright colors and cool sounds, everything comes to life when you touch the keys (numbers) or click. It is inspired by the vivid colors and figures of artists like Milo Lockett and Claudio Baldrich, who always manage to transmit so much energy and emotion. In this work, when you press the keys, colored hearts appear and move to the rhythm of instrumental music from Alice in Wonderland. Every time you interact, different things happen, which means it is never repeated. It is a work with surprises, where you are the one who creates everything that happens. It is a work that has no right or wrong way to enjoy it.
Remember that Milo and Claudio's initials are important.

**Technical, aesthetic and conceptual development**

"Symphony of Colors" is developed in p5.js, this work is perfect for giving life to interactive art. This work allows different colored hearts to appear when the numbers are pressed, generating a visual effect reminiscent of the works of Lockett and Baldrich. Additionally, the work includes a central character and an elephant that add a lovely touch, while a bubble appears when the user clicks, creating a fantasy atmosphere.

From a theoretical perspective, I was inspired by Inke Arns' idea about the performativity of code, which says that code is much more than a tool, it is an act that communicates and transforms. This is reflected in how each action in the work triggers a new combination of elements, making the work come to life in unpredictable ways. On the other hand, Aira's ideas about contemporary art, which moves between the made and the unmade, are felt in the work when the visual and sound elements emerge and mainly the bubbles disappear, creating a constant game between the visible and the invisible.
The hearts that appear with each key pressed symbolize the vitality and unpredictability of human emotions, and how they cannot be fully captured or reproduced. The music, based on "Alice in Wonderland", reinforces the feeling that everything is part of a dream that is lived only once. The influence of Lockett and Baldrich is felt in the colors and the joy of the shapes, which provide an atmosphere of warmth and play.

"Symphony of Colors" is a space where users can immerse themselves, experiment and let the colors, shapes and sounds tell a story that can only be lived in the moment, remembering that art is an experience that unfolds and disappears, just like life.
