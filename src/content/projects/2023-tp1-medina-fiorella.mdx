...
<Language code="en">
The work has a 512 x 512 canvas and is exclusive in grayscale. The image I tried to capture was that of a typewriter, using Vera Molnar's famous serial squares, writing on what would be a musical staff that, instead of playing musical notes, would play 2D primitives that would move on the staff and randomly change between triangles, circles and rectangles.
