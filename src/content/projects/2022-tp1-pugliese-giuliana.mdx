...
<Language code="en">
Title of the work: "the non-human eye"

"The non-human eye" is a work of generative art developed in the p5.js language, whose objective is to make visible the evolution between humans and technology. It is created from an ellipse that refers to the eye. The user can make an intervention on it with the mouse and modify it to their liking. The basis for choosing the main object is from wanting to reflect on the human nature of technologies and how not everything we see is as we believe it. For this same reason, we hope that the user interacts with the work consciously based on the concepts developed.

Technical, aesthetic and conceptual development

Technical, aesthetic and conceptual development (describe in a maximum of 500 words the technical, aesthetic, conceptual characteristics, artistic references and bibliography used):
